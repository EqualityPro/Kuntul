...
def page_theme():
    ...
    embed_color = theme.get("embed", {}).get("color", "#3DD68C")
  ...
  <div class="thm-col" style="flex:1 1 320px;min-width:280px;">
    ...
    <div class="thm-panel" id="thm-tampilan" hidden>
      ...
      <div class="form-group" style="border:1px solid var(--border);border-radius:10px;padding:.7rem .8rem;">
        ...
        <div style="font-size:.78rem;color:var(--muted);margin:.3rem 0 .6rem;">Bungkus kartu umum dengan embed bergaris warna (ala bot Koya). Pratinjau di sini hanya menampilkan gambarnya.</div>
